# LogicHorizon Language Specification

## 1. Introduction
LogicHorizon is a domain-specific language designed for evaluating boolean expressions and generating truth tables. It supports basic boolean operators, variable assignments, and inference rules.
